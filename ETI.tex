...
%Ogni buon ordine è isomorfo a un ordinale;
...
%Definizione di cardinale. Definizione di $\kappa^+$.
...
%Fatti ovvi tipo somme di costanti
...
\begin{itemize}
  ...
  \item $\alpha \notin V_\alpha$
\end{itemize}
%Palese che mancano i beth
%E pure la chiusura transitiva

\section{Rappresentazioni}
	...
	\begin{myexample}[Rappresentazione regolare]
		...
		% G.I. TODO Non capisco la notazione: Per cosa stanno le due C dei complessi?
	...
	%G.I. TODO Scegli solo una delle due frasi successive (Wow, such repetition)
	...
	\begin{mytheorem}[Lemma di Schur]
		Siano $\rho,\sigma$ due rappresentazioni irriducibili, e sia $\Phi$ un omomorfismo di rappresentazione. Allora o $\Phi \equiv 0$ oppure $\Phi$ è un isomorfismo.
	\end{mytheorem}
	\begin{proof}

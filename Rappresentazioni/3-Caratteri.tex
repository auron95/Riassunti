...
\begin{Achtung}
  A volte il carattere viene definito, per rappresentazioni di dimensione 1, come un omomorfismo da $G$ in $\bC^*$. Questo non vale più in dimensione maggiore: né che sia un omomorfismo, né che sia in $\bC^*$ (può anche assumere il valore $0$).
\end{Achtung}

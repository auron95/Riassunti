...
Analogamente a prima, una base per $S^mV$, con $\dim V=n$, sono i vettori della forma  $v_{i_1}v_{i_2}\dotsv_{i_m}$ con $i_1\le i_2\le \dots \le i_m$. Il conto combinatorico ci dice che $\dim S^mV = \binom{n+m-1}m$.
%$v_{i_1},v_{i_2},\dots,v_{i_m}$ immagino non ci vadano le virgole G.I. (C*)
